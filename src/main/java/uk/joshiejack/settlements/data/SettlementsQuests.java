...
public class SettlementsQuests extends AbstractPenguinRegistryProvider<Quest> {
    public SettlementsQuests(PackOutput output, ReloadableRegistry<Quest> registry) {
