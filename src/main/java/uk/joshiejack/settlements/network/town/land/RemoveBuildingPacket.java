...
public record RemoveBuildingPacket(ResourceKey<Level> dimension, int townID, TownBuilding building) implements PenguinPacket {
    public static final ResourceLocation ID = PenguinLib.prefix("remove_building");
    ...
    public RemoveBuildingPacket(FriendlyByteBuf buf) {
    ...
    public void handle(Player player) {
        WorldMap.getTownByID(dimension, townID).getLandRegistry().removeBuilding(player.level(), building);
    }
}
